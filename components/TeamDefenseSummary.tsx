...
export default function TeamDefenseSummary({ temporada, onTemporadaChange, onVolverALideres }: Props) {
  ...
  useEffect(()=>{ let cancelado=false;
    ...
    } catch(err) { console.error("Error cargando Resumen defensivo:",err); if(!cancelado) setError("No se pudo cargar el resumen desde ESPN."); }
  ...
  return <div className="w-full">
    <div className="flex items-center justify-between gap-3 border-b-2 border-blue-500 pb-3 mb-4">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <h3 className="text-sm md:text-xl font-black uppercase tracking-wider text-blue-600 font-['Orbitron'] italic underline decoration-blue-500 underline-offset-4">Resumen defensivo</h3>
      </div>
