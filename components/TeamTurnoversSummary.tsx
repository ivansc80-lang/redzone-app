    ...
    <div className="w-full overflow-x-auto border border-zinc-200 rounded-xl shadow-sm">
      <table className="min-w-[620px] w-full border-collapse text-xs">
        <thead><tr className="bg-zinc-100 text-zinc-600 font-black uppercase">
          ...
          {columnas.map((col,idx)=><th key={col} className={`min-w-[110px] px-3 py-3 text-center whitespace-nowrap border-r border-zinc-200 ${idx===1 ? "border-l-2 border-l-zinc-400" : ""}`}>{col}</th>)}
        </tr></thead>
